...
import asset8GhumRaw from '/SVG/Asset_8_Ghum.svg?raw';
                ...
                >
                    {layout.map((element) => {
                        ...
                        if (element.type === 'svg') {
                            ...
                            if (element.id === 'svg_shape8' && fields['sk_patti_type'] === 'ghum_patti') {
                                assetName = 'Asset_8_Ghum.svg';
                                rawContent = asset8GhumRaw; // Use dynamically generated and imported raw content
                            }
                        ...
                        if (element.type === 'cuffGroup') {
                            ...
                            return (
                                <div key={element.id} style={{ ...style, width: 'fit-content' }} className="flex flex-col justify-center text-xs font-semibold text-slate-600 font-urdu px-2">
                                    <select
                                        value={fields['cuff_selected'] || ''}
                                        onChange={(e) => handleFieldChange('cuff_selected', e.target.value)}
                                        className="py-1 px-2 text-xs border rounded text-center font-urdu bg-white focus:outline-none focus:ring-1 focus:ring-slate-400 appearance-none shadow-sm w-fit"
                                        style={{ fontFamily: "'NotoNastaliqUrdu', serif", maxWidth: '100%' }}
                                        dir="rtl"
                                    >
                                        <option value="" disabled>کف کا انتخاب</option>
                                        {options.map((opt: any) => (
                        ...
                        if (element.type === 'buttonDesignGroup') {
                            ...
                            return (
                                <div key={element.id} style={{ ...style, width: 'fit-content' }} className="flex flex-col justify-center text-xs font-semibold text-slate-600 font-urdu px-2">
                                    <select
                                        value={fields['button_design_selected'] || ''}
                                        onChange={(e) => handleFieldChange('button_design_selected', e.target.value)}
                                        className="py-1 px-2 text-xs border rounded text-center font-urdu bg-white focus:outline-none focus:ring-1 focus:ring-slate-400 appearance-none shadow-sm w-fit"
                                        style={{ fontFamily: "'NotoNastaliqUrdu', serif", maxWidth: '100%' }}
                                        dir="rtl"
                                    >
                                        <option value="" disabled>بٹن ڈیزائن کا انتخاب</option>
                                        {options.map((opt: any) => (
                                            <option key={opt.key} value={opt.key}>
                                                {opt.labelUr || opt.label}
                                            </option>
                            ...
                            return (
                                <div key={element.id} style={{ ...style, width: 'fit-content' }} className="flex flex-col justify-center text-xs font-semibold text-slate-600 font-urdu px-2">
                                    <select
                                        ...
                                        dir="rtl"
                                    >
                                        <option value="" disabled>کالر کا انتخاب</option>
                                        {options.map((opt: any) => (
                                            <option key={opt.key} value={opt.key}>
                                                {opt.labelUr || opt.label || ''}
                                            </option>
                        ...
                        if (element.type === 'wcCollarGroup') {
                            ...
                            return (
                                <div key={element.id} style={{ ...style, width: 'fit-content' }} className="flex flex-col justify-center text-xs font-semibold text-slate-600 font-urdu px-2">
                                    <select
                                        value={fields['wc_collar_selected'] || ''}
                                        onChange={(e) => handleFieldChange('wc_collar_selected', e.target.value)}
                                        className="py-3 px-2 text-[13px] leading-[2.2] border rounded text-center font-urdu bg-white focus:outline-none focus:ring-1 focus:ring-slate-400 appearance-none shadow-sm w-fit"
                                        style={{ fontFamily: "'NotoNastaliqUrdu', serif", maxWidth: '100%' }}
                                        dir="rtl"
                                    > 
                                        <option value="" disabled>کالر کا انتخاب</option>
                        ...
                        if (element.type === 'wcGeraGroup') {
                            ...
                            return (
                                <div key={element.id} style={{ ...style, width: 'fit-content' }} className="flex flex-col justify-center text-xs font-semibold text-slate-600 font-urdu px-2">
                                    <select
                                        value={fields['wc_gera_selected'] || ''}
                                        onChange={(e) => handleFieldChange('wc_gera_selected', e.target.value)}
                                        className="py-3 px-2 text-[13px] leading-[2.2] border rounded text-center font-urdu bg-white focus:outline-none focus:ring-1 focus:ring-slate-400 appearance-none shadow-sm w-fit"
                                        style={{ fontFamily: "'NotoNastaliqUrdu', serif", maxWidth: '100%' }}
                                        dir="rtl"
                                    >
                                        <option value="" disabled>گیرا کا انتخاب</option>
                                        {options.map((opt: any) => (
                                            <option key={opt.key} value={opt.key}>
                                                {opt.labelUr}
                                            </option>
                        ...
                        if (element.type === 'skPattiKaajGroup') {
                            return (
                                <div key={element.id} style={{...style, zIndex: 20}} className="flex flex-col justify-center gap-1.5 px-2 pointer-events-auto">
                                    ...
                                    {/* dropdown for Sada / Ghum Patti */}
                                    <select
                                        className="form-select text-[12px] font-semibold text-slate-700 font-urdu py-0 px-2 h-6 bg-white border-slate-300 rounded shadow-sm focus:ring-primary-500 text-right w-full"
                                        style={{ fontFamily: "'NotoNastaliqUrdu', serif" }}
                                        dir="rtl"
                                        value={fields['sk_patti_type'] || 'sada_patti'}
                                        onChange={(e) => handleFieldChange('sk_patti_type', e.target.value)}
                                    >
                                        <option value="sada_patti">سادہ پٹی</option>
                                        <option value="ghum_patti">گم پٹی</option>
                                    </select>
                                </div>
                            );
                        }
