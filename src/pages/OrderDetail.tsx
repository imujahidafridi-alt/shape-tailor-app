...
import { Calendar, User, Phone, FileText, Banknote, ArrowRight, ArrowLeft, Check, Printer, Eye } from 'lucide-react';
    ...
    useEffect(() => {
        const handleMessage = async (event: MessageEvent) => {
            if (event.data === 'save-pdf-request' && order && customer && customerMeasurement) {
                ...
                const html = generateMeasurementSlipHTML(customer, customerMeasurement, layout, settings, workerNames, order);
