                  ...
                  <div
                    ...
                    onContextMenu={(e) =>
                      handleContextMenu(e, "sk_asteen_type", [
                        { key: "default", labelUr: "Ø¨ØºÛŒØ± Ø¨Ú©Ø±Ù…" },
                        { key: "sada_bukram", labelUr: "Ø³Ø§Ø¯Û Ø¨Ú©Ø±Ù…" },
                        { key: "kani_asteen", labelUr: "Ú©Ù†ÛŒ Ø¢Ø³ØªÛŒÙ†" },
                        { key: "baghair_bukram_fold", labelUr: "Ø¨ØºÛŒØ± Ø¨Ú©Ø±Ù… ÙÙˆÙ„Úˆ" },
                      ])
                    }
                    title={
                      isUrdu
                        ? "ØªØ¨Ø¯ÛŒÙ„ Ú©Ø±Ù†Û’ Ú©Û’ Ù„Ø¦Û’ Ø±Ø§Ø¦Ù¹ Ú©Ù„Ú© Ú©Ø±ÛŒÚº"
                        : "Right-click to change"
                    }
                  >
